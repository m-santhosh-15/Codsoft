...
def main():
    ...
    print(instructions)
    print(f"Thank you for joining the game Mr/Mrs.{player_name}")
    print("")
    print("Mr/Mrs.{player_name},Your sign is - O")
    print("AI's sign is - X")
    ...
    for i in range(9):
        ...
        if evaluate(sign_dict, 'X'):
            ...
            print(f"Congratulations Mr/Mrs.{player_name}. You won!🎉🎉🎉")
            break
    else:
